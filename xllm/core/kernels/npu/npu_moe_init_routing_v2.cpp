...
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> apply_npu_moe_init_routing_v2(const torch::Tensor& x,
    ...
    return at_npu::native::custom_ops::npu_moe_init_routing_v2(x, expert_idx, c10::nullopt, c10::nullopt,
                                                               active_num, expert_capacity, expert_num, 0,
                                                               expert_tokens_num_type, expert_tokens_num_flag,
                                                               quant_mode, active_expert_range, 0);
}
